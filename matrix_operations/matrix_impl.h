...
namespace matrix
{
    template <typename MultStrat, typename T, std::size_t Rows, std::size_t Columns>
    class MatrixImpl
    {
    public:
        ...
        /* CRTP interface for compile-time polymorphism */
        constexpr MultStrat &impl() { return *static_cast<MultStrat *>(this); }
        constexpr MultStrat const &impl() const { return *st atic_cast<const MultStrat *>(this); }
        ...
        constexpr MatrixImpl<MultStrat, T, Rows, OtherColumns> operator*(const MatrixImpl<MultStrat, T, Columns, OtherColumns> &other) const noexcept;
    ...
    template <typename MultStrat, typename T, std::size_t Rows, std::size_t Columns>
    template <std::size_t OtherColumns>
    constexpr MatrixImpl<MultStrat, T, Rows, OtherColumns> MatrixImpl<MultStrat, T, Rows, Columns>::operator*(const MatrixImpl<MultStrat, T, Columns, OtherColumns> &other) const noexcept
    {
