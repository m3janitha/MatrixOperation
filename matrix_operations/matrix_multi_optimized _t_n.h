...
namespace matrix
{
    ...
    class MatrixOptimizedTN : public MatrixImpl<MatrixOptimizedTN<T, Rows, Columns>, T, Rows, Columns>
    {
    public:
        constexpr MatrixOptimizedTN() = default;
        constexpr explicit MatrixOptimizedTN(const std::array<std::array<T, Columns>, Rows> &data) : MatrixImpl<MatrixOptimizedTN<T, Rows, Columns>, T, Rows, Columns>(data){};

        /* import all multiplication operators */
        using MatrixImpl<MatrixOptimizedTN<T, Rows, Columns>, T, Rows, Columns>::operator*;

        template <std::size_t OtherColumns>
        constexpr MatrixOptimizedTN<T, Rows, OtherColumns> operator*(const MatrixOptimizedTN<T, Columns, OtherColumns> &other) const noexcept;
    ...
    private:
        template <std::size_t OtherColumns>
        constexpr void multiplication_parallel_aux(MatrixOptimizedTN<T, Rows, OtherColumns> &result, const MatrixOptimizedTN<T, Columns, OtherColumns> &other, std::size_t start, std::size_t end) const noexcept;
    ...
    template <typename T, std::size_t Rows, std::size_t Columns>
    template <std::size_t OtherColumns>
    constexpr void MatrixOptimizedTN<T, Rows, Columns>::multiplication_parallel_aux(MatrixOptimizedTN<T, Rows, OtherColumns> &result, const MatrixOptimizedTN<T, Columns, OtherColumns> &other, std::size_t start, std::size_t end) const noexcept
    {
    ...
    template <typename T, std::size_t Rows, std::size_t Columns>
    template <std::size_t OtherColumns>
    constexpr MatrixOptimizedTN<T, Rows, OtherColumns> MatrixOptimizedTN<T, Rows, Columns>::operator*(const MatrixOptimizedTN<T, Columns, OtherColumns> &other) const noexcept
    {
